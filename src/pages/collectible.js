...
export default function Blog() {
  ...
  const articoli = async()=>{
    ...
    `;
      ...
      const shuffledCollectibles = projectXpage.collectibles.sort(() => Math.random() - 0.5);

      console.log(shuffledCollectibles);
      setPost(shuffledCollectibles);
...
<path d="M 0 9 L 0 11 L 50 11 L 50 9 Z M 0 24 L 0 26 L 50 26 L 50 24 Z M 0 39 L 0 41 L 50 41 L 50 39 Z"></path>
     ...
     {post.map((prog,i)=>{
        return(
      <div style={{ flex: '30%'}} key={'progetto_'+i} class="flex-item imgListCollect">
<Link
  href={{
